...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>ningsu01</b> 0.0.1-SNAPSHOT
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2018-${.now?string('yyyy')} &nbsp;
                <a href="httphttps://github.com/ningsu01/" target="_blank" >xuxueli</a>
                &nbsp;
                <a href="https://github.com/ningsu01/" target="_blank" >github</a>
